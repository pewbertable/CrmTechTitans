...
// Declare jQuery variable if it's not already defined globally.  This is a common practice when using jQuery in a project.
// The issue was that the $ variable was not declared, causing an error.  This line declares it if it's not already defined.
const $ = window.$ || jQuery
